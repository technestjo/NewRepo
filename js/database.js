...
const LetterDB = {
  ...
  DB_VERSION: '2.1', // bump to force-reset stale localStorage

  DEFAULT_ADMIN: {
    username: btoa('AliAdmin'),
    password: btoa('AncientLevant$2026')
  },
  ...
  SEED_DATA: [
    {
      ...
      stages: [
        ...
        {
          id: 3,
          nameEn: 'Phoenician Aleph',
          nameAr: 'الألف الفينيقية',
          period: '~1050 BCE',
        ...
        {
          id: 4,
          nameEn: 'Aramaic / Early Semitic',
          nameAr: 'الآرامية / السامية المبكرة',
          period: '~800 BCE',
          ...
          svgContent: `<g transform="translate(100,100)">
            <path d="M 0,-72 L 0,72" stroke="currentColor" stroke-width="8" stroke-linecap="round"/>
            <path d="M 0,-20 L -36,-68 M 0,-20 L 36,-68" stroke="currentColor" stroke-width="7" stroke-linecap="round" fill="none"/>
          </g>`
        },
        {
          id: 5,
          nameEn: 'Arabic Alef with Hamza',
          nameAr: 'ألف العربية مع الهمزة',
          period: '~400 CE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'House Floor Plan (Hieroglyphic)',
          nameAr: 'مخطط البيت (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Beth',
          nameAr: 'الباء الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Throwing Stick (Hieroglyphic)',
          nameAr: 'عصا الرمي (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Gimel',
          nameAr: 'الجيمل الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Tent Door (Hieroglyphic)',
          nameAr: 'باب الخيمة (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Daleth',
          nameAr: 'الدالث الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Rejoicing Figure (Hieroglyphic)',
          nameAr: 'شخصية الابتهاج (هيروغليفية)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician He',
          nameAr: 'الهيه الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Tent Peg (Hieroglyphic)',
          nameAr: 'وتد الخيمة (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Waw',
          nameAr: 'الواو الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Sword (Hieroglyphic)',
          nameAr: 'السيف (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Zayin',
          nameAr: 'الزاين الفينيقية',
          period: '~1050 BCE',
    ...
    },
    {
      ...
      stages: [
        {
          id: 1,
          nameEn: 'Fence (Hieroglyphic)',
          nameAr: 'السياج (هيروغليفي)',
          period: '~2000 BCE',
        ...
        {
          id: 3,
          nameEn: 'Phoenician Heth',
          nameAr: 'الحيت الفينيقية',
          period: '~1050 BCE',
